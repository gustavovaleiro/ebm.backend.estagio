...
public class GrupoPermissaoService {
	...
	public Page<Permissao> findPermissoesByModulo(Modulo modulo, Integer page, Integer linesPerPage, String orderBy, String direction){
		PageRequest pageRequest = PageRequest.of(page, linesPerPage, Direction.valueOf(direction), orderBy);
		return permissaoRepository.findAllByModulo(modulo, pageRequest);
	}
