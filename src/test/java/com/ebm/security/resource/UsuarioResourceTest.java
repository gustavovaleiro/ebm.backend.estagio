...
public class UsuarioResourceTest extends BaseTest {
	...
	public void testUpdateSemMudarPessoa() throws Exception {
		...
		this.util.testPutExpectNoContent(ENDPOINT_BASE + "/" + this.bd.user1.getId(), user2).andDo(print());
...
//	@WithMockUser(username = "test", password = "test", authorities = { BASE_AUTHORITY + "PUT",
//			BASE_AUTHORITY + "POST" })
//	public void testUpdateUsuarioComPessoaPertenceOutroUsuario() throws Exception {
